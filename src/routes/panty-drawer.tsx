...
export const Route = createFileRoute("/panty-drawer")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://princesspink90.com/panty-drawer" },
    ],
    links: [{ rel: "canonical", href: "https://princesspink90.com/panty-drawer" }],
  }),
...
function PantyDrawerPage() {
  ...
  const handleBuy = (listing: PantyListing) => {
    ...
    openCheckout({
      ...
      returnUrl: `${window.location.origin}/checkout/return?provider=nowpayments&status=success`,
    });
  };
