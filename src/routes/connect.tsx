      ...
      <section className="mt-10 rounded-3xl border border-border/60 bg-card/40 p-6 sm:p-8">
        ...
        {diag && (
          <div className="mt-6 space-y-4">
            ...
            {diagRunning && (
              <div className="flex items-center gap-3 rounded-2xl border border-dashed border-border/60 bg-background/30 p-4 text-xs text-muted-foreground">
                <span className="inline-block h-2.5 w-2.5 animate-pulse rounded-full bg-amber-400" />
                Probing next endpoint…
              </div>
            )}
          </div>
        )}
